...
//public class BookingController3 {
//
//	
//	@Autowired
...
//	public ResponseEntity<Object> updateBookingById(@Valid @PathVariable long bookingId, @RequestBody Booking10 booking, BindingResult bindingResult) {
//
//		if (bindingResult.hasErrors()) {
//			List<FieldError> errors = bindingResult.getFieldErrors();
//			List<String> errorList = new ArrayList<String>();
