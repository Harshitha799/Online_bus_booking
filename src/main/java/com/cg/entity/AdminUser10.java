...
public class AdminUser10 {
	...
	public AdminUser10(int adminId, String adminUsername, String password, List<Integer> caseNumber) {
		super();
		this.adminId = adminId;
		this.adminUsername = adminUsername;
		this.password = password;
	...
	public String toString() {
		return "AdminUser10 [adminId=" + adminId + ", adminUsername=" + adminUsername + ", password=" + password
